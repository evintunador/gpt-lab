...
from nn_modules.catalog_utils import ModuleTestConfig, get_total_loss
from device import get_available_devices
from catalog_utils import discover_dunder_objects
...
def clear_test_error_maps():
    ...
    """
    folder = "nn_modules/test_error_maps"
...
def _assert_tensors_close_and_generate_heatmaps(
    ...
    base_folder: str = "nn_modules/test_error_maps",
):
    failures = []
    has_failed = False
...
ALL_TEST_CONFIGS, DISCOVERY_ERRORS = discover_dunder_objects(
    ...
    search_folders="nn_modules/catalog/"
)
